...
namespace XerahS.Indexer
{
    ...
    public class IndexerTextAsync : IndexerAsync
    {
        ...
        {
            string footer = $"Generated by XerahS Directory Indexer on {DateTime.UtcNow:yyyy-MM-dd 'at' HH:mm:ss 'UTC'}. Latest version can be downloaded from: {Links.XerahSWebsite}";
