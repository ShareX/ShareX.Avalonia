...
namespace ShareX.Ava.Common
{
    public static class GraphicsPathExtensions
    {
        ...
        {
            System.Drawing.PointF p1 = new System.Drawing.PointF(rect.X + (rect.Width / 2.0f), rect.Y);
            System.Drawing.PointF p2 = new System.Drawing.PointF(rect.X + rect.Width, rect.Y + (rect.Height / 2.0f));
            System.Drawing.PointF p3 = new System.Drawing.PointF(rect.X + (rect.Width / 2.0f), rect.Y + rect.Height);
            System.Drawing.PointF p4 = new System.Drawing.PointF(rect.X, rect.Y + (rect.Height / 2.0f));

            graphicsPath.AddPolygon(new System.Drawing.PointF[] { p1, p2, p3, p4 });
        }

        public static void AddPolygon(this GraphicsPath graphicsPath, RectangleF rect, int sideCount)
        {
            System.Drawing.PointF[] points = new System.Drawing.PointF[sideCount];

            float a = 0;

            for (int i = 0; i < sideCount; i++)
            {
                points[i] = new System.Drawing.PointF(rect.X + ((rect.Width / 2.0f) * (float)Math.Cos(a)) + (rect.Width / 2.0f),
        ...
        // TODO: WindingModeOutline requires native GDI+ interop - defer to platform abstraction layer
