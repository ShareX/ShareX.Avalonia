...
namespace ShareX.Ava.Common
{
    public class WindowInfo
    {
        ...
        public Rectangle Rectangle => NativeMethods.GetWindowRect(Handle);
        ...
        public byte Opacity
        {
            ...
            set
            {
                ...
                {
                    Layered = true;
                    NativeMethods.SetLayeredWindowAttributes(Handle, 0, value, 0x00000002); // LWA_ALPHA
                }
                else
                {
                    Layered = false;
        ...
        public void Restore()
        {
            if (IsHandleCreated)
            {
                NativeMethods.ShowWindow(Handle, 9); // Restore
            }
        }
